...
async function on_call()
{
  ...
  var div_content="<h2 class='w3-text-grey w3-padding-16'><i class='fa fa-certificate fa-fw w3-margin-right w3-xxlarge w3-text-blue'></i>Projects<button class= 'icon_btn w3-text-blue' onclick=openForm('Projects') style='font-size:24px;color:green'><i class='fa fa-plus '></i></button><button class= 'edit_btn w3-text-blue' onclick=Edit_Right('Projects') style='font-size:24px;color:green'><i class='fa fa-edit '></i></button></h2>";
  ...
  var div_content="<h2 class='w3-text-grey w3-padding-16'><i class='fa fa-book fa-fw w3-margin-right w3-xxlarge w3-text-blue'></i>Education<button class= 'icon_btn w3-text-blue' onclick=openForm('Education') style='font-size:24px;color:green'><i class='fa fa-plus '></i></button><button class= 'edit_btn w3-text-blue' onclick=Edit_Right('Education') style='font-size:24px;color:green'><i class='fa fa-edit '></i></button></h2>";
  ...
  var div_content="<h2 class='w3-text-grey w3-padding-16'><i class='fa fa-suitcase  fa-fw w3-margin-right w3-xxlarge w3-text-blue'></i>Work Experience<button class= 'icon_btn w3-text-blue' onclick=openForm('Work') style='font-size:24px;color:green'><i class='fa fa-plus '></i></button><button class= 'edit_btn w3-text-blue' onclick=Edit_Right('Work') style='font-size:24px;color:green'><i class='fa fa-edit '></i></button></h2>";
  ...
  var div_content="<p class=w3-large><b><i class='fa fa-asterisk fa-fw w3-margin-right w3-text-blue'></i>Skills<button class= 'icon_btn w3-text-blue' onclick=openForm('Skills') style='font-size:24px;color:green'><i class='fa fa-plus '></i></button><button class= 'edit_btn w3-text-blue' onclick=Edit_Left('Skills') style='font-size:24px;color:green'><i class='fa fa-edit '></i></button></b></p>";
  div_content=Array_loop_left(div_content,Skills,"Skills")
  document.getElementById("Skills").innerHTML=div_content

  var Languages=response.Languages
  var div_content="<p class=w3-large><b><i class='fa fa-asterisk fa-fw w3-margin-right w3-text-blue'></i>Languages<button class= 'icon_btn w3-text-blue' onclick=openForm('Languages') style='font-size:24px;color:green'><i class='fa fa-plus '></i></button><button class= 'edit_btn w3-text-blue' onclick=Edit_Left('Languages') style='font-size:24px;color:green'><i class='fa fa-edit '></i></button></b></p>";
  div_content=Array_loop_left(div_content,Languages,"Languages")
  document.getElementById("Languages").innerHTML=div_content


  var Courses=response.Courses
  var div_content="<p class=w3-large><b><i class='fa fa-asterisk fa-fw w3-margin-right w3-text-blue'></i>Courses<button class= 'icon_btn w3-text-blue' onclick=openForm('Courses') style='font-size:24px;color:green'><i class='fa fa-plus '></i></button><button class= 'edit_btn w3-text-blue' onclick=Edit_Course('Courses') style='font-size:24px;color:green'><i class='fa fa-edit '></i></button></b></p>";
